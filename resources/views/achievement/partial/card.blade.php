@if (Auth::user()->role === 'admin')
    <div class="flex space-x-4 mb-6">
        ...
        <a href="{{ route('achievements.index', ['status' => 'diterima']) }}"
            class="flex-1 bg-white p-4 rounded-lg shadow-md text-center hover:bg-gray-100">
        ...
        <a href="{{ route('achievements.index', ['status' => 'tunda']) }}"
            ...
            <div class="text-gray-900 text-2xl font-bold">{{ $pendingCount }}</div>
            <div class="text-gray-400 text-xs italic">Klik untuk menampilkan</div>
        </a>
        ...
        <a href="{{ route('achievements.index', ['status' => 'ditolak']) }}"
            ...
            <div class="text-gray-900 text-2xl font-bold">{{ $rejectedCount }}</div>
            <div class="text-gray-400 text-xs italic">Klik untuk menampilkan</div>
        </a>
    </div>
@endif
